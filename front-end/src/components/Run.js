               ...
               <div className="col-md-6 mt-5 mx-auto">
                 <form noValidate onSubmit={this.tryGenerate}>
                   <div className="form-group">
                     <label htmlFor="program_timeout"> Program Timeout </label>
                     <input type="number" min="4" max="600" className="form-control" name="program_timeout" placeholder="Enter program timeout in seconds"
                       value={this.state.program_timeout}
                    ...
                    <div className="form-group">
                      ...
                      <div className="form-group">
                        ...
                        <input type="number" min="0" max="4" className="form-control" name="number_of_slaves" placeholder="Enter number of slaves"
                          value={this.state.number_of_slaves}
                          onChange={this.onChange}/>
                      </div>
                      <div className="form-group">
                        <label htmlFor="number_of_init">Initial population number</label>
                        <input type="number" min="4" max="20" className="form-control" name="number_of_init" placeholder="Enter number of init population"
                          value={this.state.number_of_init}
                          onChange={this.onChange}/>
                      </div>
                      <div className="form-group">
   ...
   timerIsOn = () => {
    ...
    tryGenerate = (e) => {
        ...
        const newMPI = {
          ...
          number_of_init: this.state.number_of_init,
          program_timeout: this.state.program_timeout
        }
        this.startTimer()
     ...
     generateSuccessed = () => {
       if (this.state.isTimetableReady === 1) {
         return (
           <div>
           {this.downloadFile()}
           <h3> Conflicts: {this.state.finalConflictsNr} </h3>
       ...
       if (this.state.isTimetableReady === 2) {
         return (
           <div><h3> Timeout </h3></div>
         );
       }
     };
