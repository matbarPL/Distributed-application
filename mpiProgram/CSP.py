...
if __name__ == '__main__':
    ...
    filename = r'/home/lukasz/cloud/program/data.xlsx'
    path = r'/home/lukasz/cloud/program/timetable.xlsx'

    numOfSlaves = int(sys.argv[1])
    iterNum = int(sys.argv[2])
    mProb = int(sys.argv[3])
    cProb = int(sys.argv[4])
    roomN = int(sys.argv[5])
    if numOfSlaves == 0:
        initNumber = int(sys.argv[6])
    else:
        initNumber = int(sys.argv[6])/numOfSlaves
    ...
    if rank == 0:
        ...
        print "finalTimetableConflicts: ", finalTimetable.conflicts
        f = open("/home/lukasz/cloud/program/timetableConflicts.txt", "w")
        f.write(str(finalTimetable.conflicts))
        f.close()
